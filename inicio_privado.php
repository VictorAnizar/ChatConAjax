<?php 
   ...
   if ( !empty($_POST['texto'])) {
      $sql="INSERT INTO mensaje_pri (texto,id_usr_envia,id_usr_recibe) VALUES (:texto,:id_usr_envia,:id_usr_recibe)";
    ...
    $stmt->bindParam(':id_usr_envia',$_SESSION['id']);
    $stmt->bindParam(':id_usr_recibe',$_SESSION['idUsr']);
    $stmt->execute(); 
    $_POST['texto']='';
   }
      ...
      <script type="text/javascript">
         //se ejecuta asíncronamente
            ...
            */
            ...
            req.open('GET','chat_privado.php',true);//Inicializa el pedido
   ...
   <body onload="ajax();">
      <nav aria-label="breadcrumb">
         <ol class="breadcrumb p-3 mb-2 bg-dark">
            ...
            <a href="seleccion_chat.php"><button type="button" class="btn btn-warning">Usuarios</button></a>
      ...
      <table class="table table-borderless">
         <tr>
            ...
            <th>
               <div id="contenedor">
                  <?php 
                     if (isset($_SESSION['nombreUsr']) && isset($_SESSION['emailUsr']) && isset($_SESSION['idUsr']) ):?>
                  <p>Hablando con <?php echo $_SESSION['nombreUsr'] ?></p>
                  <?php endif; ?>
                  <div id="caja-chat">
                     <div id="chat">
                     </div>
                  </div>
                  <form action="inicio_privado.php" method="post" >
...
<!--Rocky100<>Mamba100 Contraseña de bd -->
</html>
